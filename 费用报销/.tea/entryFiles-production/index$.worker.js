...
require('../../page/init/DetailReject/DetailReject');
require('../../page/init/DetailCompleted/DetailCompleted');
require('../../page/init/DetailWithdrawn/DetailWithdrawn');
require('../../page/init/DetailCancel/DetailCancel');
require('../../page/CC/CC');
